function createSourceLinks() {
    ...
    $('.toggleSource').toggle(function() {
       $(this).parent().next('.source_code').slideDown(100);
       $(this).text("Hide source");
    },
    function() {
        $(this).parent().next('.source_code').slideUp(100);
...
function summaryToggle() {
  $('.summary_toggle').click(function() {
    ...
    var next = $(this).parent().parent().next('ul.summary');
    if (next.hasClass('compact')) {
      next.toggle();
      next.next('ul.summary').toggle();
    } 
